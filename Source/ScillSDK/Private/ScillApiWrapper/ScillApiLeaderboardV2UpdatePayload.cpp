...
void ScillApiLeaderboardV2UpdatePayload::WriteJson(JsonWriter& Writer) const
{
...
bool ScillApiLeaderboardV2UpdatePayload::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
