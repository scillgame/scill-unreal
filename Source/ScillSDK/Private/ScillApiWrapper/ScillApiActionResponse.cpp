...
void ScillApiActionResponse::WriteJson(JsonWriter& Writer) const
{
	...
	if (Challenge.IsSet())
	{
		Writer->WriteIdentifierPrefix(TEXT("challenge")); WriteJsonValue(Writer, Challenge.GetValue());
	}
	Writer->WriteObjectEnd();
}

bool ScillApiActionResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
	...
	ParseSuccess &= TryGetJsonValue(*Object, TEXT("challenge"), Challenge);
